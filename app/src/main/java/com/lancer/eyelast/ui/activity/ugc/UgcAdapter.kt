...
import com.lancer.eyelast.ui.fragment.community.recommend.RecommendAdapter
import com.lancer.eyelast.utils.GlobalUtil

import com.shuyu.gsyvideoplayer.listener.GSYSampleCallBack
import com.shuyu.gsyvideoplayer.video.base.GSYVideoPlayer

class UgcAdapter(val activity: UgcDetailActivity, var dataList: List<CommunityRecommend.Item>) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun getItemViewType(position: Int): Int {
        ...
        return when (item.type) {
            RecommendAdapter.STR_COMMUNITY_COLUMNS_CARD -> {
                if (item.data.dataType == RecommendAdapter.STR_FOLLOW_CARD_DATA_TYPE) RecommendAdapter.FOLLOW_CARD_TYPE
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int) = when (viewType) {
        RecommendAdapter.FOLLOW_CARD_TYPE -> FollowCardViewHolder(R.layout.item_ugc_detail.inflate(parent))
        ...
        when (holder) {
            is FollowCardViewHolder -> {
                ...
                when (item.data.content.type) {
                    RecommendAdapter.STR_VIDEO_TYPE -> {
                    ...
                    RecommendAdapter.STR_UGC_PICTURE_TYPE -> {
