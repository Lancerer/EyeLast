...
import com.lancer.eyelast.extension.sharedPreferences
import java.util.*
...
object GlobalUtil {
    ...
    fun getDimension(resId: Int): Int {
        return BaseApplication.context.resources.getDimensionPixelOffset(resId)
    }
    ...
    fun getResourceId(name: String, type: String): Int {
        return BaseApplication.context.resources.getIdentifier(name, type, appPackage)
    }
